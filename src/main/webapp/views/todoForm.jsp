...
<body>
	<h1 class="title">할 일 등록</h1>
	<form id="addtodoform" action="/todo/schedule" method="POST" accept-charset="utf-8">

		<div class="input_container">
			<label class="question_label">어떤 일인가요?</label><br> <br> 
			<input class="title_input" type="text" name="title" placeholder="운동하기(24자까지)" maxlength="24" required>
		</div>

		<div class="input_container">
			<label class="question_label">누가 할 일인가요?</label><br> <br> 
			<input class="name_input" type="text" name="name" placeholder="홍길동" maxlength="10" required>
		</div>

		<div class="input_container">
			<label class="question_label">우선순위를 선택해주세요.</label><br> <br>
